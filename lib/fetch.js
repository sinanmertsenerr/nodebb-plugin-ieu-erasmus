...
// Ücret bilgisi bulunamayan okulda okulun değişim öğrencisi sayfası; isteğe bağlı, varsa https olmalı.
function isExchangePage(e) {
	return e === undefined || e === null ||
		(isObject(e) && isString(e.url) && /^https:\/\//.test(e.url) && isString(e.checked));
}

function isSchool(s) {
	return isObject(s) &&
		isFeePage(s.fee_page) &&
		isExchangePage(s.exchange_page) &&
